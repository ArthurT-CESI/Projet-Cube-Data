...
?>
    ...
    <h3 style="margin-top:-5%;" class="text-center">Enregistrez votre jeu : </h3>
    <div style="margin-bottom:-10%;" class="container">
        <div class="card mx-auto">

            <form action="/jeux/createAction.php" method="POST">
                ...
                <h5 class="row offset-1" style="margin-bottom:1%;margin-top:3%;">Choisissez le Pegi de votre jeu : </h5>
                ...
                <h5 class="row offset-1" style="margin-bottom:0.5%;margin-top:3%">Choisissez le genre de votre jeu : </h5>
