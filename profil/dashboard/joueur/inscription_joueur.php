    ...
    if(!empty($_POST)){
        ...
        if (isset($_POST['inscription'])){
            ...
            if(empty($pseudo)){
                ...
                foreach ($rows as $document) {
                        $req_pseudo = $document->pseudoJoueur;
                    }
            ...
            $choixpreferences = "";
            foreach($_POST['choixpreferences'] as $valeur){
                $choixpreferences = $choixpreferences.$valeur.",";
            }

            $choixpreferences = substr($choixpreferences, 0,-1);
...
<html>
    ...
    <body>
        ...
        <div class="container" style="text-align: center;">
            <h1 style="color: white">Créez votre joueur !</h1>
        </div>
        ...
        <div class="container">
            <form id="formulaire" method="post">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input class="form-control" type="text" placeholder="Votre gamertag" name="pseudo" value="<?php if(isset($pseudo)){ echo $pseudo; }?>" required>
                    <?php
                        if (isset($er_pseudo)){
                    ?>
                ...
                <div class="col-5 mb-5">
                    <label for="validationTooltip">Préférences de jeux</label>
                    <br>
                    <br>
                    <input type="checkbox" class="btn-check" id="btn-Action" value="Action" name="choixpreferences[]"/>
                    <label class="btn btn-primary" for="btn-Action">Action</label>

                    <input type="checkbox" class="btn-check" id="btn-Aventure" value="Aventure" name="choixpreferences[]"/>
                    <label class="btn btn-primary" for="btn-Aventure">Aventure</label>

                    <input type="checkbox" class="btn-check" id="btn-Anime" value="Anime" name="choixpreferences[]"/>
                    <label class="btn btn-primary" for="btn-Anime">Anime</label>

                    <input type="checkbox" class="btn-check" id="btn-Course" value="Course" name="choixpreferences[]"/>
                    <label class="btn btn-primary" for="btn-Course">Course</label>

                    <input type="checkbox" class="btn-check" id="btn-RPG" value="RPG" name="choixpreferences[]"/>
                    <label class="btn btn-primary" for="btn-RPG">RPG</label>

                    <input type="checkbox" class="btn-check" id="btn-Simulation" value="Simulation" name="choixpreferences[]"/>
                    <label class="btn btn-primary" for="btn-Simulation">Simulation</label>
                    <br>
                    <br>
                    <input type="checkbox" class="btn-check" id="btn-Sport" value="Sport" name="choixpreferences[]"/>
                    <label class="btn btn-primary" for="btn-Sport">Sport</label>

                    <input type="checkbox" class="btn-check" id="btn-Strategie" value="Stratégie" name="choixpreferences[]"/>
                    <label class="btn btn-primary" for="btn-Strategie">Strategie</label>

                    <input type="checkbox" class="btn-check" id="btn-Survival" value="Survival" name="choixpreferences[]"/>
                    <label class="btn btn-primary" for="btn-Survival">Survival</label>

                    <input type="checkbox" class="btn-check" id="btn-Solo" value="Solo" name="choixpreferences[]"/>
                    <label class="btn btn-primary" for="btn-Solo">Solo</label>

                    <input type="checkbox" class="btn-check" id="btn-Multijoueur" value="Multijoueur" name="choixpreferences[]"/>
                    <label class="btn btn-primary" for="btn-Multijoueur">Multijoueur</label>
